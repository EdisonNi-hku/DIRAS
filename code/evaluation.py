...
def evaluate_ranker_results():
    ...
    probs = [prob_large, prob_small, prob_rerank, prob_bge_large, prob_bge_base, gpt35_listwise,
    ...
    settings = ['embed_large', 'embed_small', 'rerank_gemma', 'bge_large', 'bge_small', 'gpt35_rerank',
    ...
    for s, prob in zip(settings, probs):
        ...
        new_df = pd.DataFrame({
            ...
            "vague_auc": None,
            "binary_acc": None,
            "calibration_avg": round((2 - calibration_ece - calibration_brier) / 2, 6),
...
def evaluate_chatgpt_results():
    ...
    gpt35_guess_tok = df['gpt35_guess'].tolist()
    gpt4_guess_ask = df['gpt4_guess'].tolist()
    gpt4_conf_ask = df['gpt4_confidence'].tolist()
    gpt35_guess_ask = df['gpt35_guess'].tolist()
    gpt35_conf_ask = df['gpt35_confidence'].tolist()
    gpt4_guess_ares16 = df['gpt4_ares_guess16'].tolist()
    gpt4_conf_ares16 = df['gpt4_ares_confidence16'].tolist()
    gpt4_guess_ares = df['gpt4_ares_guess'].tolist()
    gpt4_conf_ares = df['gpt4_ares_confidence'].tolist()
    gpt4_guess_ares4 = df['gpt4_ares_guess4'].tolist()
    gpt4_conf_ares4 = df['gpt4_ares_confidence4'].tolist()
    gpt4_guess_ares2 = df['gpt4_ares_guess2'].tolist()
    gpt4_conf_ares2 = df['gpt4_ares_confidence2'].tolist()
    gpt4_guess_ares0 = df['gpt4_ares_guess0'].tolist()
    gpt4_conf_ares0 = df['gpt4_ares_confidence0'].tolist()
    gpt4_guess_prob = df['gpt4_guess_prob'].tolist()
    gpt4_conf_prob = df['gpt4_probability'].tolist()
    gpt4_ragas = df['gpt4_ragas_score'].tolist()
    gpt4_guess_ares_b16 = df['gpt4_ares_guess_b16'].tolist()
    gpt4_conf_ares_b16 = df['gpt4_ares_confidence_b16'].tolist()
    gpt4_guess_ares_b8 = df['gpt4_ares_guess_b8'].tolist()
    gpt4_conf_ares_b8 = df['gpt4_ares_confidence_b8'].tolist()
    gpt4_guess_ares_b4 = df['gpt4_ares_guess_b4'].tolist()
    gpt4_conf_ares_b4 = df['gpt4_ares_confidence_b4'].tolist()
    gpt4_guess_ares_b2 = df['gpt4_ares_guess_b2'].tolist()
    gpt4_conf_ares_b2 = df['gpt4_ares_confidence_b2'].tolist()
    gpt4_ragas_guess = ['yes' if i > 0 else 'no' for i in gpt4_ragas]

    df_test = pd.read_csv('data/chatreport_test.csv')
    settings = ['gpt4_ask', 'gpt4_tok', 'gpt4_nb', 'gpt4_no_cot', 'gpt35_ask', 'gpt35_tok', 'gpt4_ares', 'gpt4_prob', 'gpt4_ragas', 'gpt4_ares4', 'gpt4_ares2', 'gpt4_ares0', 'gpt4_ares16', 'gpt4_ares2b', 'gpt4_ares4b', 'gpt4_ares8b', 'gpt4_ares16b']
    gs = [gpt4_guess_ask, gpt4_guess_tok, gpt4_guess_nb, gpt4_guess_no_cot, gpt35_guess_ask, gpt35_guess_tok, gpt4_guess_ares, gpt4_guess_prob, gpt4_ragas_guess, gpt4_guess_ares4, gpt4_guess_ares2, gpt4_guess_ares0, gpt4_guess_ares16, gpt4_guess_ares_b2, gpt4_guess_ares_b4, gpt4_guess_ares_b8, gpt4_guess_ares_b16]
    cs = [gpt4_conf_ask, gpt4_conf_tok, gpt4_conf_nb, gpt4_conf_no_cot, gpt35_conf_ask, gpt35_conf_tok, gpt4_conf_ares, gpt4_conf_prob, gpt4_ragas, gpt4_conf_ares4, gpt4_conf_ares2, gpt4_conf_ares0, gpt4_conf_ares16, gpt4_conf_ares_b2, gpt4_conf_ares_b4, gpt4_conf_ares_b8, gpt4_conf_ares_b16]
